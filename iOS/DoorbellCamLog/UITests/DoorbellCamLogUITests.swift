...
final class DoorbellCamLogUITests: XCTestCase {
    ...
    func testAddItemFlow() {
        ...
        let field1 = app.textFields["fieldTitle"]
        XCTAssertTrue(field1.waitForExistence(timeout: 2))
        field1.tap()
        field1.typeText("Test Title")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Title"].waitForExistence(timeout: 2))
    }
